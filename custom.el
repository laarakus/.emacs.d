(custom-set-variables
 ...
 '(helm-swoop-move-to-line-cycle nil t)
 '(helm-swoop-pre-input-function (quote #[0 "\300\301!\207" [thing-at-point symbol] 2]))
 ...
 '(package-selected-packages
   (quote
    (dash helm-lsp lsp-ui lsp-mode git-timemachine diff-hl git-gutter which-key helm-ag flycheck kubernetes magit exec-path-from-shell avy ivy-rich flx counsel ivy restclient coffee-mode lorem-ipsum apache-mode itail logview impatient-mode skewer-mode nginx-mode web-beautify js2-mode web-mode w3m php-mode gnuplot helm-emms emms bbdb-vcard bbdb rainbow-delimiters beacon zenburn-theme use-package undo-tree rainbow-mode org-plus-contrib helm-swoop helm-projectile helm-descbinds helm-company hc-zenburn-theme company-web company-restclient)))
